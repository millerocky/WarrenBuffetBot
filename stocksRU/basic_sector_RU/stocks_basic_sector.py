...
# Создаю массив с данными о котировках компаний-эмитентов
stocksBasic_data = []
...
stocksBasic_data.append(Magnit_rub)
...
stocksBasic_data.append(X5Retail_rub)
...
stocksBasic_data.append(Detskiy_mir_rub)
...
stocksBasic_data.append(Lenta_rub)
...
stocksBasic_data.append(FixPrice_rub)
...
stocksBasic_data.append(MVID_rub)
...
stocksBasic_data.append(Cherkizovo_rub)
